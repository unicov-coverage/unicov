...
describe("Test Unicov.", () => {
  test("Test fromCoverage by json reporter.", async () => {
    ...
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/common-json-coverage.json")
      .toString();
  ...
  test("Test fromCoverage by cobertura reporter.", async () => {
    ...
    const commonCoverage = unicov.getCoverageData();
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/common-cobertura-coverage.json")
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
  ...
  test("Test fromCoverage by jacoco reporter.", async () => {
    ...
    const commonCoverage = unicov.getCoverageData();
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/jacoco-coverage.json")
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
  ...
  test("Test fromCoverage by xccov reporter.", async () => {
    ...
    const commonCoverage = unicov.getCoverageData();
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/xccov-coverage.json")
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
  ...
  test('Test fromCoverage by json reporter with option "caseSensitive" is false.', async () => {
    ...
    const commonCoverageContent = fs
      .readFileSync(
        "./test/fixtures/common-json-coverage-case-insensitive.json"
      )
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
  ...
  test("Test fromCoverage by auto reporter.", async () => {
    ...
    const commonCoverageContentJson = fs
      .readFileSync("./test/fixtures/common-json-coverage.json")
      .toString();
    ...
    const commonCoverageContentCobertura = fs
      .readFileSync("./test/fixtures/common-cobertura-coverage.json")
      .toString();
    expect(commonCoverageCobertura).toEqual(
      JSON.parse(commonCoverageContentCobertura)
    );
    ...
    const commonCoverageContentJacoco = fs
      .readFileSync("./test/fixtures/jacoco-coverage.json")
      .toString();
    expect(commonCoverageJacoco).toEqual(
      JSON.parse(commonCoverageContentJacoco)
    );
    ...
    const commonCoverageContentXccov = fs
      .readFileSync("./test/fixtures/xccov-coverage.json")
      .toString();
  ...
  test("Test invalid json coverage file.", async () => {
    await expect(
      ...
      "Invalid json coverage reporter: ./test/fixtures/invalid-json-coverage.json"
    );
  });
  ...
  test("Test invalid cobertura coverage file.", async () => {
    await expect(
      ...
      "Invalid cobertura coverage reporter: ./test/fixtures/invalid-cobertura-coverage.xml"
    );
  });
  ...
  test("Test invalid jacoco coverage file.", async () => {
    await expect(
      ...
      "Invalid jacoco coverage reporter: ./test/fixtures/invalid-jacoco-coverage.xml"
    );
  });
  ...
  test("Test fromCoverages with single coverage reporter.", async () => {
    ...
    const commonCoverage = unicov.getCoverageData();
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/jacoco-coverage-merged.json")
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
  ...
  test("Test fromCoverages with multi coverage reporters automatically.", async () => {
    ...
    const commonCoverageContent = fs
      .readFileSync("./test/fixtures/coverage-auto-merged.json")
      .toString();
    expect(commonCoverage).toEqual(JSON.parse(commonCoverageContent));
  });
